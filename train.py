...
@ex.config
def config():
    logdir = 'runs/transcriber-' + datetime.now().strftime('%y%m%d-%H%M%S') + "_MRD-Conv + BiLSTM (no combined_stack, conv_block_6 channel=128, freq -> low,mid,high, input add specgram delta)"
